...
class manager(object):
  ...
  def shift_model_back(self):
    ...
    ## QRef INSERT
    ## fix for model not being shifted back correctly when sort_atoms = False
    # print
    # print('phenix.pdbtools translate=\"' + str(round(self.shift_cart()[0], 4)) + ' ' + str(round(self.shift_cart()[1], 4)) + ' ' + str(round(self.shift_cart()[2], 4)) + '\"')
    # print
    ## QRef END
